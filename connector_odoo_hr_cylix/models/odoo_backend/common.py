...
class OdooBackend(models.Model):
    ...
    import_from_date_hr_attendance_late = fields.Datetime(
        "Import HR Attendance Late From Date"
    )
    export_from_date_hr_attendance_late = fields.Datetime(
        "Export HR Attendance Late From Date"
    )
    ...
    def import_hr_attendance_late(self):
        ...
        self._import_from_date(
            "odoo.hr.attendance.late", "import_from_date_hr_attendance_late"
        )
        return True
    ...
    def export_hr_attendance_late(self):
        ...
        self._export_from_date(
            "odoo.hr.attendance.late", "export_from_date_hr_attendance_late"
        )
        return True

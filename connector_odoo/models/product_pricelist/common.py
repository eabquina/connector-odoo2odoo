...
class OdooProductPricelist(models.Model):
    ...
    odoo_id = fields.Many2one(
        comodel_name="product.pricelist", string="Pricelist", required=True, ondelete="cascade"
    )
...
class OdooProductPricelistItem(models.Model):
    ...
    odoo_id = fields.Many2one(
        comodel_name="product.pricelist.item", string="Pricelist Rule", required=True, ondelete="cascade"
    )

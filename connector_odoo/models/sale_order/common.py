...
class OdooSaleOrder(models.Model):
    ...
    odoo_id = fields.Many2one(
        comodel_name="sale.order", string="Sales Order", required=True, ondelete="cascade"
    )
...
class OdooSaleOrderLine(models.Model):
    ...
    odoo_id = fields.Many2one(
        comodel_name="sale.order.line", string="Sales Order Line", required=True, ondelete="cascade"
    )
